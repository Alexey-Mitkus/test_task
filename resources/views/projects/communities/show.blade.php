            ...
            <div class="col-lg-9 col-md-12 mt-4 ">
                <div class="ml-0 mr-0 news__background news-post__content">
                    ...
                    <div class="col-lg-12 col-md-12 pt-2">
                        <a href="{{ route('community-project.index') }}" class="text-dark datetext d-flex justify-content-between">
                            <div class="news-post__article">
                                {{$post->labels[0]}}
                            </div>
                            <span class="news-post__date">
                                {{Date::parse($post->published)->format('d/m/Y г.')}}
                            </span>
                        </a>
                    </div>
