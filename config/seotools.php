...
return [
    'meta' => [
         ...
         */
        'defaults'       => [
            'title'        => "Проектное сообщество", // set false to total remove
            'titleBefore'  => true, // Put defaults.title before page title, like 'It's Over 9000! - Dashboard'
            'description'  => 'Мы - сообщество лидеров изменений, развивающих здравоохранение города Москвы', // set false to total remove
            'separator'    => ' - ',
            'keywords'     => [
