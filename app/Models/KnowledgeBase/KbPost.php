...
class KbPost extends Model
{
    ...
    {
    	return $this->belongsToMany('App\Models\KnowledgeBase\KbTheme', 'kb_posts_has_themes', 'post_id', 'theme_id');
    }

    public function formats()
    {
    	return $this->belongsToMany('App\Models\KnowledgeBase\KbFormat', 'kb_posts_has_formats', 'post_id', 'format_id');
    }
    ...
    {
    	return $this->belongsToMany('App\Models\User', 'kb_posts_has_likes', 'post_id', 'user_id');
    }

    public function tags()
    {
        return $this->belongsToMany('App\Models\KnowledgeBase\KbTag', 'kb_posts_has_tags', 'post_id', 'tag_id');
    }
